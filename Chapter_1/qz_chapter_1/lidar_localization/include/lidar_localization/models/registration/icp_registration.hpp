...
class ICPRegistration: public RegistrationInterface 
{
  public:
    ...
    ICPRegistration(float max_dist, float eculi_eps, float trans_eps, int max_iter);
  ...
  private:
    bool SetRegistrationParam(float max_dist, float eculi_eps, float trans_eps, int max_iter);
